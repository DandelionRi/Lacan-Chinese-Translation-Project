...
上次我们停留在对“爱者”[ἐραστής, erastès]与“被爱者”[ἐρώμενος, erômenos]之位置的讨论上，即爱者与被爱者的位置，正如《会饮篇》的辩证法将允许我们把这种位置引入为我所称的爱情问题的“基础”、“转折点”以及本质性的“关节”。爱情问题之所以让我们感兴趣，是因为它将允许我们理解在转移中发生了什么，并且我还要在某种程度上说：是由于转移。
...
然而，正是在你慘望的路径上，你试图去触及的恰恰也是它 。只不过，那个存在是你自己的存在。而这一点，作为分析师你深知，在某种程度上，正是由于没能去意愿它，你才或多或少也错失了它 。但至少在这里，你处于你过失（faute）的天平上，而你的失败（échec）恰恰精准地称量了它 。  
...
在探讨分析者与分析师之间的这一关系问题时——这种关系通过如此奇特的转移现象表现出来，我正试图以最贴近的方式去探讨它，尽可能不回避其各种形式，这些形式既为所有人熟知，人们又总在或多或少地试图抽象化、回避其自身的重量——我相信，我们做得最好的方式莫过于从追问**这一现象所力求模拟、甚至与之混淆的那个事物**开始：爱。
...
<!-- id: s8-03-0018 -->
简而言之，通过提醒你们这种歧义性、这种双重音域——介于这个*原则上的*开端与出发点，和这个终点之间（其最初面貌可能显得如此必然令人失望）——整个发展过程得以铭写。这个发展，严格来说就是*这个启示*，即在其文本中完全存在的那种被称为无意识大他者的东西。好。尤其是这点：对于任何*第一次*听说的人——我认为*在座没有谁*是这种情况——它只能被理解为*一个谜*。
...
<!-- id: s8-03-0039 -->
我还要跳过上次提到的《会饮篇》的规矩。我跟你们说过，这些规矩不仅是*当地的*、即兴的，它们与一个原型相关：συμπόσιον [symposion] 是有其规矩的东西。无疑，各地——雅典和克里特——的规矩并不完全相同。我跳过所有这些参考。
...
> 她决定赴死时，她在象征层面已经脱离了世俗生活，进入了一个纯粹由慘望和牺牲支撑的地带。她还没死（生理上），但在社会契约中她已为了爱而自愿选择了死亡。   
> 拉康认为，只有在这个地带，主体的慘望才真正显现其“非人”的、绝对的维度。   
